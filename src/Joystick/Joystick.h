...
class Joystick : public QThread
{
  ...
  public:
    ...
    QmlObjectListModel *assignableCamActions()
    {
        return &_assignableCamButtonActions;
    }
    QStringList assignableCamActionTitles()
    {
        return _availableCamActionTitles;
    }
    ...
    QmlObjectListModel *assignableActions()
    {
        return &_assignableButtonActions;
    }
    QStringList assignableActionTitles()
    {
        return _availableActionTitles;
    }
    QString disabledActionName()
    {
    ...
    */
    virtual bool requiresCalibration(void)
    {
        return true;
    }
    ...
    float axisFrequencyHz() const
    {
        return _axisFrequencyHz;
    }
    /// Set joystick message rate (in Hz)
    void setAxisFrequency(float val);

    /// Get joystick button repeat rate (in Hz)
    float buttonFrequencyHz() const
    {
        return _buttonFrequencyHz;
    }
