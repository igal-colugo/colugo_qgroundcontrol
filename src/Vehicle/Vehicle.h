...
class Vehicle : public FactGroup
{
  ...
  public:
    Vehicle(LinkInterface *link, int vehicleId, int defaultComponentId, MAV_AUTOPILOT firmwareType, MAV_TYPE vehicleType, FirmwarePluginManager *firmwarePluginManager,
    ...
    Vehicle(MAV_AUTOPILOT firmwareType, MAV_TYPE vehicleType, FirmwarePluginManager *firmwarePluginManager, QObject *parent = nullptr);
    ...
    /// Command vehicle to move to specified location (generated by nextvision payload)
    Q_INVOKABLE void CCamGuideModeGotoLocation(const QGeoCoordinate &gotoCoord);
    ...
    int flowImageIndex() const
    {
        return _flowImageIndex;
    }
    ...
    bool messageTypeNone()
    {
        return _currentMessageType == MessageNone;
    }
    bool messageTypeNormal()
    {
        return _currentMessageType == MessageNormal;
    }
    bool messageTypeWarning()
    {
        return _currentMessageType == MessageWarning;
    }
    bool messageTypeError()
    {
        return _currentMessageType == MessageError;
    }
    int newMessageCount() const
    {
    ...
    {
        return static_cast<bool>(_onboardControlSensorsPresent & SysStatusSensorGPS);
    }
    bool hilMode() const
    {
    ...
    {
        return &_altitudeRelativeFact;
    }
    Fact *altitudeAMSL()
    {
        return &_altitudeAMSLFact;
    }
    Fact *altitudeMonotonic()
    {
        return &_altitudeMonotonicFact;
    }
    Fact *altitudeTuning()
    {
        return &_altitudeTuningFact;
    }
    Fact *altitudeTuningSetpoint()
    {
        return &_altitudeTuningSetpointFact;
    }
    Fact *xTrackError()
    {
        return &_xTrackErrorFact;
    }
    Fact *rangeFinderDist()
    {
        return &_rangeFinderDistFact;
    }
    Fact *flightDistance()
    {
        return &_flightDistanceFact;
    }
    Fact *distanceToHome()
    {
        return &_distanceToHomeFact;
    }
    Fact *missionItemIndex()
    {
        return &_missionItemIndexFact;
    }
    ...
    Fact *headingToHome()
    {
        return &_headingToHomeFact;
    }
    Fact *distanceToGCS()
    {
        return &_distanceToGCSFact;
    }
    Fact *hobbs()
    {
        return &_hobbsFact;
    ...
    FactGroup *escStatusFactGroup()
    {
        return &_escStatusFactGroup;
    }
    ...
    void sendMavCommand(int compId, MAV_CMD command, bool showError, float param1 = 0.0f, float param2 = 0.0f, float param3 = 0.0f, float param4 = 0.0f, float param5 = 0.0f,
    ...
    Q_INVOKABLE void sendCommand(int compId, int command, bool showError, double param1 = 0.0, double param2 = 0.0, double param3 = 0.0, double param4 = 0.0, double param5 = 0.0,
    ...
    void sendMavCommandWithHandler(MavCmdResultHandler resultHandler, void *resultHandlerData, int compId, MAV_CMD command, float param1 = 0.0f, float param2 = 0.0f, float param3 = 0.0f,
    ...
    void requestMessage(RequestMessageResultHandler resultHandler, void *resultHandlerData, int compId, int messageId, float param1 = 0.0f, float param2 = 0.0f, float param3 = 0.0f,
    ...
    {
        return static_cast<qreal>(_curGimbalRoll);
    }
    qreal gimbalPitch() const
    {
        return static_cast<qreal>(_curGimbalPitch);
    }
    qreal gimbalYaw() const
    {
        return static_cast<qreal>(_curGimbalYaw);
    }
    bool gimbalData() const
    {
        return _haveGimbalData;
    }
  ...
  public slots:
    ...
    void _joystickEnabledChanged(bool enabled, bool isCameraJoystick);
  ...
  private:
    ...
    void _sendMavCommandWorker(bool commandInt, bool showError, MavCmdResultHandler resultHandler, void *resultHandlerData, int compId, MAV_CMD command, MAV_FRAME frame, float param1,
    ...
    static const char *_altitudeMonotonicFactName;
