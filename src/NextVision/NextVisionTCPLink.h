...
class NextVisionTCPConfiguration : public NextVisionLinkConfiguration
{
    Q_OBJECT
  ...
  public:
    ...
    NextVisionTCPConfiguration(const QString &name);
    NextVisionTCPConfiguration(NextVisionTCPConfiguration *source);
    ...
    {
        return NextVisionLinkConfiguration::TypeTcp;
    }
...
class NextVisionTCPLink : public NextVisionLinkInterface
{
    Q_OBJECT

  public:
    NextVisionTCPLink(SharedNextVisionLinkConfigurationPtr &config);
    virtual ~NextVisionTCPLink();
  ...
  private:
    ...
    NextVisionTCPConfiguration *_tcpConfig;
    QTcpSocket *_socket;
