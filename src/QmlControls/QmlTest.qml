...
Rectangle {
    ...
    property var palette: QGCPalette {
        colorGroupEnabled: true
    }
    property var enabledPalette: QGCPalette {
        colorGroupEnabled: true
    }
    property var disabledPalette: QGCPalette {
    ...
    function exportThemeCPP() {
        ...
        for (var i = 0; i < palette.colors.length; i++) {
            ...
            var csc = cs + 'Colors'
            palToExport += 'DECLARE_QGC_COLOR(' + cs + ', \"' + palette[csc][1]
                    + '\", \"' + palette[csc][0] + '\", \"' + palette[csc][3]
                    + '\", \"' + palette[csc][2] + '\")\n'
        }
    ...
    function exportThemePlugin() {
        ...
        for (var i = 0; i < palette.colors.length; i++) {
            ...
            palToExport += 'if (colorName == QStringLiteral(\"' + cs
        ...
        Column {
            ...
            Row {
                ...
                QGCButton {
                    ...
                    enabled: themeImportExportEdit.text[0] === "{"
                             && _jsonButton.checked
                    onClicked: {
                    ...
                    Column {
                        ...
                        Grid {
                            ...
                            QGCComboBox {
                                width: ctlPrevColumn._colWidth
                                height: ctlPrevColumn._height
                                model: [qsTr("Item 1"), qsTr("Item 2"), qsTr(
                                        "Item 3")]
                            }
                            QGCComboBox {
                                width: ctlPrevColumn._colWidth
