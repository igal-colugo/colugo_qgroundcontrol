...
class QGroundControlQmlGlobal : public QGCTool
{
  ...
  public:
    ...
    {
        return _qgcPositionManager;
    }
    MissionCommandTree *missionCommandTree()
    {
        return _missionCommandTree;
    }
    ...
    {
        return _taisyncManager;
    }
#if defined(QGC_GST_TAISYNC_ENABLED)
    bool taisyncSupported()
    {
        return true;
    }
#else
    ...
    {
        return _microhardManager;
    }
#if defined(QGC_GST_TAISYNC_ENABLED)
    bool microhardSupported()
    {
        return true;
    }
#else
    ...
    bool skipSetupPage() const
    {
        return _skipSetupPage;
    }
