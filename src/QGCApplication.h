...
#include "NextVision/NextVisionLinkConfiguration.h"
...
class QGCApplication : public QApplication
{
  ...
  public:
    ...
    QTranslator &qgcJSONTranslator(void)
    {
        return _qgcTranslatorJSON;
    }

    void setLanguage();
    QQuickWindow *mainRootWindow();
    uint64_t msecsSinceBoot(void)
    {
  ...
  public slots:
    ...
    const QLocale getCurrentLanguage()
    {
        return _locale;
    }
