...
public:
    ...
    virtual void ColugoProprietaryCommand(Vehicle* vehicle, MAV_CMD command, MAV_FRAME frame, bool showError, float param1, float param2, float param3, float param4, double param5, double param6,
                                          float param7);
