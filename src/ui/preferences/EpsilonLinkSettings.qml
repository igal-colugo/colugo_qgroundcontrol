...
Rectangle {
    ...
    function openCommSettings(originalLinkConfig) {
        ...
        if (originalLinkConfig) {
            ...
            settingsLoader.editingConfig = QGroundControl.epsilonLinkManager.startConfigurationEditing(originalLinkConfig)
        } else {
            // Create new link configuration
            settingsLoader.editingConfig = QGroundControl.epsilonLinkManager.createConfiguration(EpsilonLinkConfiguration.TypeUdp, "")
        }
    ...
    Component.onDestruction: {
        if (settingsLoader.sourceComponent) {
            ...
            QGroundControl.epsilonLinkManager.cancelConfigurationEditing(settingsLoader.editingConfig)
        }
    }
    ...
    QGCFlickable {
        ...
        Column {
            ...
            Repeater {
                model: QGroundControl.epsilonLinkManager.linkConfigurations
                delegate: QGCButton {
                    ...
                    onClicked: {
                        ...
                        QGroundControl.epsilonLinkManager.selectConfiguration(_currentSelection)
                    }
                }
            }
        }
    ...
    Row {
        ...
        QGCButton {
            ...
            MessageDialog {
                ...
                onYes: {
                    QGroundControl.epsilonLinkManager.removeConfiguration(_currentSelection)
        ...
        QGCButton {
            text:       qsTr("Connect")
            enabled:    _currentSelection && !_currentSelection.link
            onClicked:  QGroundControl.epsilonLinkManager.createConnectedLink(_currentSelection)
        }
        QGCButton {
                        ...
                        ColumnLayout {
                            ...
                            GridLayout {
                                ...
                                QGCComboBox {
                                    ...
                                    model:                  QGroundControl.epsilonLinkManager.linkTypeStrings
                                    ...
                                    onActivated: {
                                        if (index !== editingConfig.linkType) {
                                            ...
                                            // Create new link configuration
                                            editingConfig = QGroundControl.epsilonLinkManager.createConfiguration(index, name)
                                        }
                                    }
                                }
                            }
                    ...
                    RowLayout {
                        ...
                        QGCButton {
                            ...
                            onClicked: {
                                ...
                                settingsLoader.sourceComponent = null
                                if (originalLinkConfig) {
                                    QGroundControl.epsilonLinkManager.endConfigurationEditing(originalLinkConfig, editingConfig)
                                } else {
                                    // If it was edited, it's no longer "dynamic"
                                    editingConfig.dynamic = false
                                    QGroundControl.epsilonLinkManager.endCreateConfiguration(editingConfig)
                                }
                            }
                        }
