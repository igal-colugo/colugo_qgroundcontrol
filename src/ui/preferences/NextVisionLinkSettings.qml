...
Rectangle {
    ...
    function openCommSettings(originalLinkConfig) {
        ...
        if (originalLinkConfig) {
            ...
            settingsLoader.editingConfig = QGroundControl.nextVisionLinkManager.startConfigurationEditing(originalLinkConfig)
        } else {
            // Create new link configuration
            settingsLoader.editingConfig = QGroundControl.nextVisionLinkManager.createConfiguration(NextVisionLinkConfiguration.TypeUdp, "")
        }
    ...
    Component.onDestruction: {
        if (settingsLoader.sourceComponent) {
            ...
            QGroundControl.nextVisionLinkManager.cancelConfigurationEditing(settingsLoader.editingConfig)
        }
    }
    ...
    QGCFlickable {
        ...
        Column {
            ...
            Repeater {
                model: QGroundControl.nextVisionLinkManager.linkConfigurations
                delegate: QGCButton {
    ...
    Row {
        ...
        QGCButton {
            ...
            MessageDialog {
                ...
                onYes: {
                    QGroundControl.nextVisionLinkManager.removeConfiguration(_currentSelection)
        ...
        QGCButton {
            text:       qsTr("Connect")
            enabled:    _currentSelection && !_currentSelection.link
            onClicked:  QGroundControl.nextVisionLinkManager.createConnectedLink(_currentSelection)
        }
        QGCButton {
                        ...
                        ColumnLayout {
                            ...
                            GridLayout {
                                ...
                                QGCComboBox {
                                    ...
                                    model:                  QGroundControl.nextVisionLinkManager.linkTypeStrings
                                    ...
                                    onActivated: {
                                        if (index !== editingConfig.linkType) {
                                            ...
                                            // Create new link configuration
                                            editingConfig = QGroundControl.nextVisionLinkManager.createConfiguration(index, name)
                                        }
                                    }
                                }
                            }
                    ...
                    RowLayout {
                        ...
                        QGCButton {
                            ...
                            onClicked: {
                                ...
                                settingsLoader.sourceComponent = null
                                if (originalLinkConfig) {
                                    QGroundControl.nextVisionLinkManager.endConfigurationEditing(originalLinkConfig, editingConfig)
                                } else {
                                    // If it was edited, it's no longer "dynamic"
                                    editingConfig.dynamic = false
                                    QGroundControl.nextVisionLinkManager.endCreateConfiguration(editingConfig)
                                }
                            }
                        }
