...
DECLARE_SETTINGSFACT(AppSettings, enableStandardPhotoVideo)
DECLARE_SETTINGSFACT(AppSettings, enableNextVision)
DECLARE_SETTINGSFACT(AppSettings, enableEpsilon)
DECLARE_SETTINGSFACT(AppSettings, enableCommtact)
DECLARE_SETTINGSFACT(AppSettings, enableAsio)
