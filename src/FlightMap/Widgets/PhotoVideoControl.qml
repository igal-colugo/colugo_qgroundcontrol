...
Rectangle {
    ...
    color: "#80000000"
    radius: _margins
    visible: (_mavlinkCamera || _videoStreamAvailable || _simpleCameraAvailable)
    ...
    function toggleShooting() {
        ...
        } else if (_onlySimpleCameraAvailable
                   || (_simpleCameraAvailable && _anyVideoStreamAvailable
                       && _videoStreamInPhotoMode && !videoGrabRadio.checked)) {
    ...
    GridLayout {
        ...
        onWidthChanged: {
            console.log("Photo video control:", grid.width, grid.height)
        }
        ...
        QGCColoredImage {
            ...
            Layout.preferredHeight: rowHeight
            Layout.preferredWidth: Layout.preferredHeight //columnWidth * Layout.columnSpan
            Layout.fillWidth: false
            Layout.fillHeight: false
            Layout.alignment: Qt.AlignHCenter
        ...
        QGCRadioButton {
            ...
            enabled: _showModeIndicator && !_mavlinkCamera
                     && _simpleCameraAvailable && _videoStreamInPhotoMode
        ...
        QGCRadioButton {
            id: cameraTriggerRadio
            font.pointSize: ScreenTools.smallFontPointSize
            text: qsTr("Camera Trig")
            checked: true
            enabled: _showModeIndicator && !_mavlinkCamera
                     && _simpleCameraAvailable && _videoStreamInPhotoMode
        ...
        Rectangle {
            ...
            Layout.row: videoGrabRadio.visible ? 2 : 1
            Layout.rowSpan: videoGrabRadio.visible ? 1 : 3
            Layout.columnSpan: 6

            Layout.preferredHeight: rowHeight
            Layout.preferredWidth: rowHeight //columnWidth * Layout.columnSpan
            Layout.fillWidth: false
            Layout.fillHeight: false
            Layout.alignment: Qt.AlignHCenter
        ...
        QGCLabel {
            text: _activeVehicle ? ('00000' + _activeVehicle.cameraTriggerPoints.count).slice(
                                       -5) : "00000"
            enabled: _modeIndicatorPhotoMode
            ...
            ColumnLayout {
                ...
                GridLayout {
                    ...
                    QGCComboBox {
                        Layout.fillWidth: true
                        sizeToContents: true
                        model: [qsTr("Off"), qsTr("Blend"), qsTr("Full"), qsTr(
                                "Picture In Picture")]
                    ...
                    Repeater {
                        ...
                        RowLayout {
                            ...
                            property var _fact: _mavlinkCamera.getFact(
                                                    modelData)
                            property bool _isBool: _fact.typeIsBool
                            property bool _isCombo: !_isBool
                                                    && _fact.enumStrings.length > 0
                            property bool _isSlider: _fact && !isNaN(
                                                         _fact.increment)
                            property bool _isEdit: !_isBool && !_isSlider
                                                   && _fact.enumStrings.length < 1
