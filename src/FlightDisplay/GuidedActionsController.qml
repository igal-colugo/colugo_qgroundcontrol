...
Item {
    ...
    readonly property string changeAltMessage: qsTr(
    ...
    property string setWaypointMessage: qsTr("Adjust current waypoint to %1.").arg(
                                            _actionData)
    ...
    readonly property string startEngineMessage: qsTr("Start engine.")
    readonly property string stopEngineMessage: qsTr("Stop engine.")
    ...
    readonly property int actionStartEngine: 26
    readonly property int actionStopEngine: 27
    ...
    property bool showEmergenyStop: _guidedActionsEnabled && !_hideEmergenyStop
    ...
    property bool showDisarm: _guidedActionsEnabled && _vehicleArmed
                              && !_vehicleFlying
    property bool showRTL: _guidedActionsEnabled && _vehicleArmed
                           && _activeVehicle.guidedModeSupported
                           && _vehicleFlying && !_vehicleInRTLMode
    property bool showTakeoff: _guidedActionsEnabled
                               && _activeVehicle.takeoffVehicleSupported
                               && !_vehicleFlying && _canArm
    property bool showLand: _guidedActionsEnabled
                            && _activeVehicle.guidedModeSupported
                            && _vehicleArmed && !_activeVehicle.fixedWing
                            && !_vehicleInLandMode
    property bool showStartMission: _guidedActionsEnabled && _missionAvailable
                                    && !_missionActive && !_vehicleFlying
                                    && _canArm
    property bool showContinueMission: _guidedActionsEnabled
                                       && _missionAvailable && !_missionActive
                                       && _vehicleArmed && _vehicleFlying
                                       && (_currentMissionIndex < _missionItemCount - 1)
    property bool showPause: _guidedActionsEnabled && _vehicleArmed
                             && _activeVehicle.pauseVehicleSupported
                             && _vehicleFlying && !_vehiclePaused
                             && !_fixedWingOnApproach
    property bool showChangeAlt: _guidedActionsEnabled && _vehicleFlying
                                 && _activeVehicle.guidedModeSupported
                                 && _vehicleArmed && !_missionActive
    property bool showChangeSpeed: _guidedActionsEnabled && _vehicleFlying
                                   && _activeVehicle.guidedModeSupported
                                   && _vehicleArmed && !_missionActive
    property bool showOrbit: _guidedActionsEnabled && _vehicleFlying
                             && __orbitSupported && !_missionActive
    property bool showROI: _guidedActionsEnabled && _vehicleFlying
                           && __roiSupported && !_missionActive
    property bool showLandAbort: _guidedActionsEnabled && _vehicleFlying
                                 && _fixedWingOnApproach
    property bool showGotoLocation: _guidedActionsEnabled && _vehicleFlying
    property bool showActionList: _guidedActionsEnabled
                                  && (showStartMission || showResumeMission
                                      || showChangeAlt || showLandAbort)
    ...
    property bool showResumeMission: _activeVehicle && !_vehicleArmed
                                     && _vehicleWasFlying && _missionAvailable
                                     && _resumeMissionIndex > 0
    ...
    property bool _guidedActionsEnabled: (!ScreenTools.isDebug
                                          && _corePluginOptions.guidedActionsRequireRCRSSI
                                          && _activeVehicle) ? _rcRSSIAvailable : _activeVehicle
    property string _flightMode: _activeVehicle ? _activeVehicle.flightMode : ""
    property bool _missionAvailable: missionController.containsItems
    property bool _missionActive: _activeVehicle ? _vehicleArmed
                                                   && (_vehicleInLandMode
                                                       || _vehicleInRTLMode
                                                       || _vehicleInMissionMode) : false
    ...
    property bool _rcRSSIAvailable: _activeVehicle ? _activeVehicle.rcRSSI > 0
                                                     && _activeVehicle.rcRSSI <= 100 : false
    property bool _fixedWingOnApproach: _activeVehicle ? _activeVehicle.fixedWing
                                                         && _vehicleLanding : false
    property bool _fixedWing: _activeVehicle ? _activeVehicle.fixedWing
    ...
    property bool __roiSupported: _activeVehicle ? !_hideROI
                                                   && _activeVehicle.roiModeSupported : false
    property bool __orbitSupported: _activeVehicle ? !_hideOrbit
                                                     && _activeVehicle.orbitModeSupported : false
    property bool __flightMode: _flightMode

    function _outputState() {
        if (_corePlugin.guidedActionsControllerLogging()) {
            console.log(qsTr("_activeVehicle(%1) _vehicleArmed(%2) guidedModeSupported(%3) _vehicleFlying(%4) _vehicleWasFlying(%5) _vehicleInRTLMode(%6) pauseVehicleSupported(%7) _vehiclePaused(%8) _flightMode(%9) _missionItemCount(%10) roiSupported(%11) orbitSupported(%12) _missionActive(%13) _hideROI(%14) _hideOrbit(%15)").arg(
                            _activeVehicle ? 1 : 0).arg(_vehicleArmed ? 1 : 0).arg(
                            __guidedModeSupported ? 1 : 0).arg(_vehicleFlying ? 1 : 0).arg(
                            _vehicleWasFlying ? 1 : 0).arg(_vehicleInRTLMode ? 1 : 0).arg(
                            __pauseVehicleSupported ? 1 : 0).arg(_vehiclePaused ? 1 : 0).arg(
                            _flightMode).arg(_missionItemCount).arg(
                            __roiSupported).arg(__orbitSupported).arg(
    ...
    function setupSlider(actionCode) {
        ...
        if (actionCode === actionTakeoff) {
            ...
            guidedValueSlider.setValue(
                        _activeVehicle ? _activeVehicle.minimumTakeoffAltitude(
                                             ) : 0)
            ...
            if (_activeVehicle.vtolInFwdFlight) {
                ...
                guidedValueSlider.setMinVal(
                            _activeVehicle.minimumEquivalentAirspeed())
                guidedValueSlider.setMaxVal(
                            _activeVehicle.maximumEquivalentAirspeed())
                guidedValueSlider.setValue(
                            _activeVehicle.airSpeedSetpoint.rawValue)
            } else {
                guidedValueSlider.setDisplayText("Set Speed")
                guidedValueSlider.setMinVal(0.1)
                guidedValueSlider.setMaxVal(
                            _activeVehicle.maximumHorizontalSpeedMultirotor())
                guidedValueSlider.setValue(
                            _activeVehicle.maximumHorizontalSpeedMultirotor(
                                ) / 2)
            }
        } else if (actionCode === actionChangeAlt || actionCode === actionOrbit
                   || actionCode === actionGoto || actionCode === actionPause) {
    ...
    on_FlightModeChanged: {
        ...
        _vehicleInRTLMode
                = _activeVehicle ? _flightMode === _activeVehicle.rtlFlightMode
                                   || _flightMode === _activeVehicle.smartRTLFlightMode : false
    ...
    Connections {
        ...
        function onResumeMissionUploadFail() {
            confirmAction(actionResumeMissionUploadFail)
        }
    }

    Connections {
        target: mainWindow
        function onArmVehicleRequest() {
            armVehicleRequest()
        }
        function onForceArmVehicleRequest() {
            forceArmVehicleRequest()
        }
        function onDisarmVehicleRequest() {
            disarmVehicleRequest()
        }
        function onVtolTransitionToFwdFlightRequest() {
            vtolTransitionToFwdFlightRequest()
        }
        function onVtolTransitionToMRFlightRequest() {
    ...
    function confirmAction(actionCode, actionData, mapIndicator) {
        ...
        case actionArm:
            ...
            confirmDialog.hideTrigger = Qt.binding(function () {
                return !showArm
            })
            break
        case actionForceArm:
        ...
        case actionStartEngine:
            confirmDialog.title = startEngineTitle
            confirmDialog.message = startEngineMessage
            guidedValueSlider.visible = false
            break
        case actionStopEngine:
            confirmDialog.title = stopEngineTitle
            confirmDialog.message = stopEngineMessage
            guidedValueSlider.visible = false
            break
        default:
    ...
    function executeAction(actionCode, actionData, sliderOutputValue, optionChecked) {
        ...
        case actionResumeMissionUploadFail:
            missionController.resumeMission(
                        missionController.resumeMissionIndex)
            break
        case actionStartMission:
        case actionContinueMission:
        ...
        case actionEmergencyStop:
            ...
            break
        case actionChangeAlt:
            _activeVehicle.guidedModeChangeAltitude(sliderOutputValue,
                                                    false /* pauseVehicle */
                                                    )
            break
        case actionGoto:
        ...
        case actionOrbit:
            _activeVehicle.guidedModeOrbit(
                        orbitMapCircle.center, orbitMapCircle.radius(
                            ) * (orbitMapCircle.clockwiseRotation ? 1 : -1),
                        _activeVehicle.altitudeAMSL.rawValue + sliderOutputValue)
            break
        case actionLandAbort:
            _activeVehicle.abortLanding(
                        50) // hardcoded value for climbOutAltitude that is currently ignored
            break
        case actionPause:
            _activeVehicle.guidedModeChangeAltitude(sliderOutputValue,
                                                    true /* pauseVehicle */
        ...
        case actionChangeSpeed:
            if (_activeVehicle) {
                if (_activeVehicle.vtolInFwdFlight
                        || _activeVehicle.fixedWing) {
                    _activeVehicle.guidedModeChangeEquivalentAirspeed(
                                sliderOutputValue)
                } else {
                    _activeVehicle.guidedModeChangeGroundSpeed(
                                sliderOutputValue)
                }
            }
            break
        case actionStartEngine:
            _activeVehicle.setEngine(1, false)
            break
        case actionStopEngine:
            _activeVehicle.setEngine(0, false)
            break
        default:
